  ...
  return (
    <>
      {gear.shield && renderItem(
        gear.shield,
        { position: "absolute", top: "50%", left: "50%", transform: "translate(-85%, -20%)", height: "80%", width: "80%", zIndex: zBase, opacity: 0.95 },
      ...
      {gear.weapon && renderItem(
        gear.weapon,
        { position: "absolute", top: "50%", left: "50%", transform: "translate(-20%, -10%) rotate(25deg)", transformOrigin: "bottom center", height: "55%", width: "55%", zIndex: zBase + 1, opacity: 0.95 },
