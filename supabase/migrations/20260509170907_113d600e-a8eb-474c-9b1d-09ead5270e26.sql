...
BEGIN
  ...
  -- Frame branch (epic/legendary only, 30% chance)
  ...
  -- Equipment drop chance per rarity
  ...
  ELSE
    INSERT INTO public.avatar_exp_logs (user_id, exp_amount, reason, reference_date)
      VALUES (_user_id, (v_reward->>'amount')::int, 'gacha', _result_date);
