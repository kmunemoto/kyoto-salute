                  ...
                  <div className="h-52">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={chartData}>
                        ...
                        <Line key={`${selectedExercise}-weight`} yAxisId="w" type="monotone" dataKey="weight" stroke="hsl(18, 90%, 55%)" strokeWidth={2.5} isAnimationActive={false} dot={{ r: 5, fill: "hsl(18, 90%, 55%)", strokeWidth: 2, stroke: "hsl(var(--background))" }} activeDot={{ r: 7 }} name="重量(kg)" />
                        <Line key={`${selectedExercise}-reps`} yAxisId="r" type="monotone" dataKey="reps" stroke="hsl(210, 80%, 55%)" strokeWidth={2} strokeDasharray="5 5" isAnimationActive={false} dot={{ r: 4, fill: "hsl(210, 80%, 55%)", strokeWidth: 2, stroke: "hsl(var(--background))" }} name="回数" />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                ) : (
