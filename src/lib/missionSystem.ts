...
export const MISSIONS: MissionDef[] = [
  ...
  { key: "volume_king", name: "ボリュームキング", icon: "Crown", description: "総挙上量3,000kg以上", exp: 25 },
  ...
  { key: "set_master", name: "セットマスター", icon: "Layers", description: "合計12セット以上", exp: 15 },
  { key: "full_menu", name: "フルメニュー", icon: "ListChecks", description: "4種目以上トレーニング", exp: 15 },
  { key: "endurance", name: "エンデュランス", icon: "Activity", description: "1種目で合計30rep以上", exp: 20 },
  { key: "heavy_lifter", name: "ヘビーリフター", icon: "Weight", description: "自体重以上の重量を挙げる", exp: 25 },
  { key: "balancer", name: "バランサー", icon: "Scale", description: "上半身と下半身の両方をトレーニング", exp: 15 },
  { key: "double_best", name: "ダブルベスト", icon: "Medal", description: "2種目以上で自己ベスト更新", exp: 40 },
  { key: "high_rep", name: "ハイレップ", icon: "Zap", description: "いずれかのセットで15rep以上", exp: 10 },
  { key: "super_setter", name: "スーパーセッター", icon: "Flame", description: "合計15セット以上", exp: 20 },
];
